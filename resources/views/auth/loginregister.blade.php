...
<body>
                        ...
                        <div class="container">
                            ...
                            <ul class="header-bar-nav nav nav-register">
                                <li><a href="{{ route('renter.cart') }}"><i class="fa fa-shopping-cart"
                                            aria-hidden="true"></i> Cart <span class="badge badge-pill badge-danger">{{
                                            $paidHousesCount }}</span></a></li>
                        ...
                        <div class="block-content block-content-small-padding">
                            <div class="block-content-inner">
                                ...
                                <div class="agents-list clearfix">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div style="padding-right:40px; padding-left:40px" class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="box">
                                                        <form action="{{ route('login') }}" method="POST">
                                                            ...
                                                            <div style="font-size:15px" class="form-group center">
                                                                <label>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div style="padding-left:40px; padding-right:40px" class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="box">
                                                        <form method="POST" action="{{ route('register') }}">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label>First {{ __('Name') }}</label>
                                                                <input placeholder="Enter Your First Name" id="name"
                                                                    type="text"
                                                            ...
                                                            <div class="form-group">
                                                                <label>Last {{ __('Name') }}</label>
                                                                <input placeholder="Enter Your Last Name" id="name"
                                                                    type="text"
                                                                    class="form-control @error('name') is-invalid @enderror"
                                                            ...
                                                            <input type="hidden" name="role_id" class="form-control"
                                                                @error('role_id') is-invalid @enderror" id="role_id"
                                                                value="3" required autocomplete="role_id" autofocus>
                                                            ...
                                                            <div style="margin-top:-30px; margin-left:20px"
                                                                class="form-group">
                                                                <label for="checkbox">
                                                                    By clicking you accept our <a target="_blank"
                                                                        href="{{ route('privacy') }}">privacy policy
                                                                        and terms and conditions</a>
                                                                </label>
                                                            </div>

                                                            <div class="form-group">
                                                                <input id="btncheck" type="submit" value="Register"
                                                                    class="btn btn-primary btn-inversed btn-block">
                                                            </div><!-- /.form-group -->
                                                        </form>
                                                    </div><!-- /.box -->
    ...
    <script type="text/javascript"
        src="https://nyumbafasta.co.tz/assets/libraries/jquery-bxslider/jquery.bxslider.min.js">
    </script>
    ...
    <script type="text/javascript" src="https://nyumbafasta.co.tz/assets/js/jquery.js"></script>
    <script type="text/javascript" src="https://nyumbafasta.co.tz/assets/libraries/isotope/jquery.isotope.min.js">
    </script>

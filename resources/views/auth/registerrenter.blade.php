                        ...
                        <div class="container">
                            ...
                            <ul class="header-bar-nav nav nav-register">
                                <li><a href="{{ route('renter.cart') }}"><i class="fa fa-shopping-cart"
                                            ...
                                            class="badge badge-pill badge-danger">{{ $paidHousesCount }}</span></a></li>
                            ...
                            <div class="block-content-inner">
                                <div class="row">
                                    <div class="col-sm-4 col-sm-offset-4">
                                        <h2 class="center">Register As Renter</h2>
                                        ...
                                        <div class="box">
                                            <form method="POST" action="{{ route('register') }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="Enter Your Phone Number" id="contact"
                                                        type="tel"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="Repeat Your Passwords"
                                                    id="cpassword" type="password" class="form-control"
                                                        name="password_confirmation" required
                                                        autocomplete="new-password">

                                                        <i class="far fa-eye eyespan" id="toggleCPassword"
                                                        style="cursor: pointer;"></i>
                                                ...
                                                <div style="margin-top:-30px; margin-left:20px" class="form-group">
                                                    <label for="checkbox">
                                                        By clicking you accept our <a target="_blank"
                                                            href="{{ route('privacy') }}">privacy policy and terms and
                                                            conditions</a>
                                                    </label>
                                                </div>
...
<script>
    ...
    <script type="text/javascript">
        ...
        var clickBtn = document.getElementsByClassName('checkbox')[0];

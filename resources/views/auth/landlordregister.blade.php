                            ...
                            <div class="block-content-inner">
                                <div class="row">
                                    <div class="col-sm-4 col-sm-offset-4">
                                        <h2 class="center">Register As Landlord</h2>
                                        ...
                                        <div class="box">
                                            <form method="POST" action="{{ route('register') }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="Enter Your Last Name" id="name" type="text"
                                                        class="form-control @error('name') is-invalid @enderror"
                                                ...
                                                <input type="hidden" name="role_id" class="form-control"
                                                    @error('role_id') is-invalid @enderror" id="role_id" value="2"
                                                ...
                                                <div class="checkbox">
                                                  ...
                                                  <label for="checkbox">
                                                    ...
                                                    href="{{ route('privacy') }}">privacy policy and terms and conditions</a>
                                                  </label>
                                                  </div>

...
<div id="wrapper">
    ...
    <li><a href="{{ route('renter.cart') }}"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
        Cart <span class="badge badge-pill badge-danger" style="background-color:#ff0000; border-radius: 50px; padding:2px;" >{{ $paidHousesCount }}</span></a></li>
        <li><a href="{{ route('renter.wishlist') }}"><i class="fa fa-heart" aria-hidden="true"  ></i> Wishlist <span class="badge badge-pill badge-danger" style="background-color:#ff0000; border-radius: 50px; padding:2px;" >0</span></a></li>
            ...
            <div class="container">
                <div class="header-identity">
                    <a href="/" class="header-identity-target">
                        ...
                        <span class="header-slogan">NYUMBA FASTA <br> KIGANJANI</span><!-- /.header-slogan -->
                </div><!-- /.header-identity -->

                <div class="header-actions pull-right">
                <a href="{{ route('landlord.register') }}" class="btn btn-regular">Register as LandLord</a> <strong class="separator">or</strong> <a href="{{ route('landlord.login') }}" class="btn btn-primary"><i class="fa fa-plus"></i>Login To Submit Property</a>
                </div><!-- /.header-actions -->
...
<div class="container">
    ...
    @endif
                                            ...
                                            <div class="form-group">
                                                <label>Login</label>
                                                <input name="contact" value="{{ old('contact') }}" type="tel" class="form-control" placeholder="Enter your Phone Number">
                                            </div><!-- /.form-group -->
                                            ...
                                            <div class="form-group">
                                                <p style="text-align: center"><a href="{{ route('renter.register') }}">Or Register</a></p>
                                            </div><!-- /.form-group -->
                                        </form>
                                    </div><!-- /.box -->
                                </div>

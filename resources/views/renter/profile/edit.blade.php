        ...
        <div class="row justify-content-center">
            <div class="col-md-9">
                <div class="card mt-5">
                    ...
                    <form action="{{ route('renter.profile.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('renter.profile.show') }}" class="btn btn-danger wave-effect" >Back</a>
                        </div>
                  </form>

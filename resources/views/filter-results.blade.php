    ...
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
        ...
        <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
          <a href="{{ route('renter.houses.details', $house->id) }}" class="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
            <div class="p-4">
        ...
        @empty
            <h2 class="center caps"> No Record Found</h2>
        @endforelse
      </div>
    </div>
  </body>

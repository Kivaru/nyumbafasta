            ...
            <div class="card my-5">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><span class="btn btn-danger">Request Contact</span></td>
                            </tr>
                            <tr>
                    ...
                    <div class="row gallery">
                        ...
                        <div class="col-md-3 paddingx">
                            <a href="{{ asset('public/images/'.$picture) }}">
                                <img src="{{ asset('public/images/'.$picture) }}" class="img-fluid m-2"
            ...
            <div class="card my-5">
                ...
                <div class="card-body">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <img class="mr-3"
                                src="{{ $review->user->image!=null ? asset('public/profile_photo/'. $review->user->image) : asset('public/profile_photo/default.png') }}"
                                width="35" height="35"

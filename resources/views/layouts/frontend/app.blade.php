                            ...
                            <div class="block-content-inner">
                                <div class="row">
                                    <div class="col-sm-4 col-sm-offset-4">
                                        <h2 class="center">Login As Landlord</h2>
                                        ...
                                        <div class="box">
                                            <form action="{{ route('login') }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <label>Login</label>
                                                    <input name="contact" value="{{ old('contact') }}" type="tel"
                        ...
                        <div class="container">
                            ...
                            <div class="center">
                                <ul class="social">
                                    ...
                                    <li><a href="http://www.twitter.com/nyumbafasta" target="_blank"><i
                                                class="fa fa-twitter"></i></a></li>
                                    <li><a href="http://www.instagram.com/nyumba_fasta" target="_blank"><i

            ...
            <div class="col-md-9">
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('dalali.house.update', $houseDB->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="rent" id="rent" name="rent" value="{{ $houseDB->rent }}" required>
                            </div>
            ...
            if (typeof jQuery === 'undefined') {
                ...
                $(document).ready(function() {
                    ...
                    $('#region').on('change', function(e) {
                        ...
                        //ajax
                        $.get('http://127.0.0.1:8000/dalali/ajax/district?region_id=' + region_id,
                            function(data) {
                                //success data
                ...
                $(document).ready(function() {
                    $('#district').on('change', function(e) {
                        ...
                        //ajax
                        $.get('http://127.0.0.1:8000/dalali/ajax/area?area_id=' + district_id,
                            function(data) {
                                //success data
                                //    console.log(district_id);

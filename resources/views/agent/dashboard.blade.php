...
<div class="container">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 welcome text-center my-4">
            <h1 class="name">Welcome to Landlord Panel - <span style="padding: 5px;color:black;background:#eb8000;border-radius: 20px 20px 20px 20px ;font: size 2px;vw;"> {{ Auth::user()->name }}</span></h1>  
        </div>
    </div>

    ...
    <div id="header-inner">
        <div class="header-bar">
            <div class="container">
                ...
                <li  style="background-color:#ff0000; border-radius: 50px;"><a href="{{ route('renter.wishlist') }}"><i class="fa fa-heart" aria-hidden="true"></i> Favorites <span class="badge badge-pill badge-danger">{{ $wishlistCount }}</span></a></li>

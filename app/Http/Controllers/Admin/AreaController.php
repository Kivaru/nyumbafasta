...
class AreaController extends Controller
{
    ...
    {
        $areas = Area::orderBy('name', 'ASC')->paginate(50);
    ...
    public function show($id)
    {

        {
            ...
            $houses = House::with('media')->where('area_id', $id)->paginate(20);

            return view('admin.area.show', compact('houses'));
        }
    ...
    public function destroy(Area $area)
    {
        ...
        $area->delete();
        return redirect(route('admin.area.index'))->with('success', 'Area Removed Successfully');
    }
}
